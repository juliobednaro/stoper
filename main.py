...
class Stopwatch:
    def __init__(self, screen):
        ...
        self.stop = False
        self.CLOCK_STOPPED_TEXT = self.font.render("STOPPED", False, (255,255, 0))

    def change_clock_state(self):
    ...
    def show_clock(self):
        ...
        if self.stop:
            ...
            self.screen.blit(self.CLOCK_STOPPED_TEXT, ((600 - self.CLOCK_STOPPED_TEXT.get_width() )//2, 0))
